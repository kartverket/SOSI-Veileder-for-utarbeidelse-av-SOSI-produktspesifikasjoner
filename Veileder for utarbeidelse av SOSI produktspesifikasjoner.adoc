...
:utplukkveileder: link:https://register.geonorge.no/nasjonale-standarder-og-veiledere/veiledere/veileder-i-%C3%A5-modellere-en-produktspesifikasjon-som-utplukk-fra-sosi-fagomr%C3%A5der[Veileder i å modellere SOSI produktspesifikasjon som utplukk fra SOSI fagområder^]
...
:eksempeldokument: link:https://register.geonorge.no/nasjonale-standarder-og-veiledere/veiledere/eksempel-p%C3%A5-sosi-produktspesifikasjon[Eksempel på SOSI produktspesifikasjon^]
...
image::figurer/loype.png["Løype for å lage en produktspesifikasjon"]
...
|2024-oktober|Åsmund Tjora|Overført dokument fra Word-format til AsciiDoc-format. Mindre rettinger.
|====